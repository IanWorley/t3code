 ...
 * behind `npx t3` / `npm i -g t3`: one `@ianworleyxyz/t3-<platformKey>` package per
...
export { NPM_PLATFORM_PACKAGE_SCOPE };
export const NPM_LAUNCHER_PACKAGE_NAME = NPM_PACKAGE_NAME;
