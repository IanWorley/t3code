...
it("formats package runner commands from their cache entry paths", () => {
  for (const [entryPath, expected] of [
    ["/home/theo/.npm/_npx/abc123/node_modules/t3/dist/bin.mjs", "npx @ianworleyxyz/t3 serve"],
    [
      "C:\\Users\\theo\\AppData\\Local\\npm-cache\\_npx\\abc\\node_modules\\t3\\dist\\bin.mjs",
      "npx @ianworleyxyz/t3 serve",
    ],
    [
      "/home/theo/.cache/pnpm/dlx/abc/node_modules/t3/dist/bin.mjs",
      "pnpm dlx @ianworleyxyz/t3 serve",
    ],
    [
    ...
    ["/home/theo/.bun/install/cache/t3@0.0.31/dist/bin.mjs", "bunx @ianworleyxyz/t3 serve"],
    ["/tmp/bunx-1000-t3@latest/node_modules/t3/dist/bin.mjs", "bunx @ianworleyxyz/t3 serve"],
    [
      "C:\\Users\\theo\\AppData\\Local\\Temp\\bunx-0-t3@latest\\node_modules\\t3\\dist\\bin.mjs",
      "bunx @ianworleyxyz/t3 serve",
    ],
  ] as const) {
...
it("re-suggests the prerelease channel only for prerelease builds", () => {
  for (const [version, expected] of [
    ["0.0.31-nightly.20260729", "npx @ianworleyxyz/t3@nightly serve"],
    ["0.0.31-preview.20260729.1", "npx @ianworleyxyz/t3@preview serve"],
    ["0.0.31-foo-preview.20260729.1", "npx @ianworleyxyz/t3 serve"],
    ["0.0.31", "npx @ianworleyxyz/t3 serve"],
  ] as const) {
    assert.equal(
      formatCliCommand({
        subcommand: "serve",
...
it("formats serve suggestions to match the launching command", () => {
  assert.equal(
    ...
    "npx @ianworleyxyz/t3@nightly serve",
  );
  assert.equal(
    formatCliCommand({
      subcommand: "serve",
