...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    searchTerms: [
      "VibeProxy CLI proxy manager start stop restart executable config YAML agents cli codex claude cursor grok opencode antigravity google sign in sign out install subscription instances authentication api key models configuration binary path config directory endpoint arguments environment variables display name accent color custom favorite hidden auto compact",
    ],
  },
  {
    id: "usage-providers",
